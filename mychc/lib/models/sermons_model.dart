...
Sermons sermonsFromJson(String str) => Sermons.fromJson(json.decode(str));

String sermonsToJson(Sermons data) => json.encode(data.toJson());
...
class RelatedPlaylists {
  ...
  factory RelatedPlaylists.fromJson(Map<String, dynamic> json) =>
      RelatedPlaylists(likes: json["likes"], uploads: json["uploads"]);

  Map<String, dynamic> toJson() => {"likes": likes, "uploads": uploads};
}
...
class Localized {
  ...
  factory Localized.fromJson(Map<String, dynamic> json) =>
      Localized(title: json["title"], description: json["description"]);
